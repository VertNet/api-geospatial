...
class Parser():
    ...
    def parse(self):
        ...
        # Validity
        if self.flags['hasCoordinates'] == "True":
            self.validCoordinates()

        if self.flags['hasCountry'] == "True":
            self.validCountry()
        ...
        if 'validCoordinates' in self.flags and self.flags['validCoordinates'] == "True":
            ...
            if self.flags['hasScientificName'] == "True": self.flags['validScientificName'] = "True"  # TODO: REMOVE WHEN validScientificName IS IMPLEMENTED
            if 'validScientificName' in self.flags and self.flags['validScientificName'] == "True":
